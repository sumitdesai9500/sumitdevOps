					...
					<div class="col-lg-12 col-md-12 col-sm-12">
						<form action="student-personal-information.php" method="post">
							...
							<div class="row">
								<div class="col-md-6 pr-5">
									<div class="form-group">
										<label for="exampleInputEmail1">Total Marks (InterMediate/HSC/Equiv Marks):*</label>
										<input type="number" name="total_marks" class="form-control" placeholder="Marks" value=<?php echo $row['total_marks'] ?>>
									</div>
								</div>
								<div class="col-md-6 pr-5">
									<div class="form-group">
										<label for="exampleInputPassword1">Obtain Marks (InterMediate/HSC/Equiv Marks):*</label>
